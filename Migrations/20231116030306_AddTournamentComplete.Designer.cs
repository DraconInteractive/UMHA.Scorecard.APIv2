...
namespace ScorecardAPI.Migrations
{
    ...
    [Migration("20231116030306_AddTournamentComplete")]
    partial class AddTournamentComplete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ScorecardAPI.Models.MatchEvent", b =>
                {
                    ...
                    b.Property<bool>("ApplyHealthReduction")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("ScorecardAPI.Models.DisqualificationEvent", b =>
                {
                    b.HasBaseType("ScorecardAPI.Models.MatchEvent");
            ...
            modelBuilder.Entity("ScorecardAPI.Models.PenaltyEvent", b =>
                {
                    b.HasBaseType("ScorecardAPI.Models.MatchEvent");
                    ...
                    b.ToTable("MatchEvents", t =>
                        {
                            t.Property("Reason")
                                .HasColumnName("PenaltyEvent_Reason");
                        });

                    b.HasDiscriminator().HasValue("Penalty");
                });

            modelBuilder.Entity("ScorecardAPI.Models.StrikeEvent", b =>
                {
                    b.HasBaseType("ScorecardAPI.Models.MatchEvent");

                    b.HasDiscriminator().HasValue("Strike");
                });
